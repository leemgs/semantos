...
| **Knowledge Base (KB)** | Python, Neo4j, FAISS | 튜닝 설정의 메타데이터, 의존성 그래프, 역사적 결과를 저장합니다[cite: 946, 1007]. |
...
| **Operator Console** | TypeScript, Vue.js (시뮬레이션됨) | CLI/웹 대시보드를 통해 운영자가 설명을 검토하고 결정을 승인/거부할 수 있도록 합니다[cite: 964, 1017]. |
